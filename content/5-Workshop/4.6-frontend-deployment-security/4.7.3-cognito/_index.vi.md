...
1. COGNITO_USER_POOL_ID: định danh User Pool.
    ![Tao User Pool](/images/5-Workshop/4.6-frontend-deployment-security/4.7.3-cognito/overview.png)
    
    *Vào User Pool và lấy user pool id*

2. COGNITO_CLIENT_ID: định danh App Client.
    ![Tao App Client](/images/5-Workshop/4.6-frontend-deployment-security/4.7.3-cognito/app_client.png)
...
2. Kiểm tra token trả về (ID/Access token) và xác nhận gọi API có Authorization hợp lệ.
    ...
    ![kiểm tra login/logout và token](/images/5-Workshop/4.6-frontend-deployment-security/4.7.3-cognito/check.png)
    
    *Kiểm tra login/logout và token*

3. Kiểm tra group

    ![kiểm tra group](/images/5-Workshop/4.6-frontend-deployment-security/4.7.3-cognito/group.png)
